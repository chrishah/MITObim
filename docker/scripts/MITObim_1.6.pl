...
#This version of MITObim 1.6 is meant to be used in the docker image only. It uses mira 3.4.1.1 from the specific path in the image.
#
use strict;
use warnings;
use Getopt::Long;
...
my $shme = "";
my ($mirapath, $mira, $convert_project, $mirabait) = ("/home/src/mira_3.4.1.1", "mira", "convert_project", "mirabait");
my $trim_off = "";
